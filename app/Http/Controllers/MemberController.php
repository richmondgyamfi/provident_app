...
class MemberController extends Controller
{
    ...
    public function loanApplication()
    {
        ...
        return view('members.loan-application', compact('loanTypes'));
    }
    ...
    public function storeWithdrawal(Request $request)
    {
        ...
        \App\Models\Withdrawal::create($request->only('amount', 'reason', 'notes'));
    ...
    public function storeLoan(Request $request)
    {
        ...
        $loan = \App\Models\Loan::create($loanData);
        ...
        return redirect()->route('loan-application')->with('success', 'Loan application submitted! Ref: ' . $loan->application_ref);
    }
