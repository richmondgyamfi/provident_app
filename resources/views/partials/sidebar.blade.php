        ...
        <aside id="sidebar"
            ...
            <nav class="flex-1 px-4 py-2 space-y-1 overflow-y-auto">
                ...
                <a class="{{ request()->routeIs('admin-dashboard') ? $activeClass : $inactiveClass }}" href="{{ route('admin-dashboard') }}">
                    <span class="material-symbols-outlined">dashboard</span>
                ...
                {{-- <a class="{{ request()->routeIs('members.*') ? $activeClass : $inactiveClass }}" href="{{ route('members.index') }}">
                    <span class="material-symbols-outlined">groups</span>
                ...
                <a class="{{ request()->routeIs('contributions') ? $activeClass : $inactiveClass }}" href="payroll-contribution">
                    <span class="material-symbols-outlined">payments</span>
                    <span class="text-sm">Payroll &amp; Contribution</span>
                </a>

                <a class="{{ request()->routeIs('loans.*') ? $activeClass : $inactiveClass }}" href="loan-application">
                    <span class="material-symbols-outlined">receipt_long</span>
                    <span class="text-sm">Loans</span>
                </a>
            ...
            <div class="p-4 border-t border-slate-200 dark:border-slate-800">
                ...
                <form action="{{ route('logout') }}" method="POST" class="inline">
                    @csrf
                    <button type="submit" class="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors text-left">
                ...
                <div class="mt-1 flex items-center justify-between px-3 py-2">
                    ...
                    <button
                        ...
                        "
                    >
                        <span class="toggle-thumb absolute top-[3px] left-[3px] w-[16px] h-[16px] rounded-full bg-white shadow-sm"></span>
                    </button>
                </div>
                ...
                <div class="mt-3 flex items-center gap-3 px-3">
                    <div
                        class="size-8 rounded-full bg-slate-200 dark:bg-slate-700 bg-cover bg-center shrink-0"
                        style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuASp_0O3dTNtAamg755r-gYpLYEJQIV2W9a1PAIKT-eIjggRe7UjYEyuzbDcD5HubjeTpxxMOa4XuZtEPPSDNelE2dAXi63-BWVU11vviKerwh0vXiZZtCv7PmJG3QX6bb4KPwr2hZBikqxSjUlnV-7x6vg2atf1zV2aDZU7ITNi-dpj0ubnVdAEaRdxMaCY43TUCMY_t4WGO3kABP1y09Y3Na3pfZqohnlCTtMFbt0bvhU4oh_EencKXIhYvpVlwyqD8IVhl8hDcY')"
                        aria-label="Administrator user profile picture"
                    ></div>
                    <div class="flex-1 overflow-hidden">
                        <p class="text-xs font-bold text-slate-900 dark:text-white truncate">Alex Johnson</p>
                        <p class="text-[10px] text-slate-500 truncate">Head of Finance</p>
                    </div>
                </div>
