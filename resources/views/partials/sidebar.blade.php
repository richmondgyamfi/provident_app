...
<aside id="sidebar"
    ...
    <nav class="flex-1 px-4 py-2 space-y-1 overflow-y-auto">
        ...
        @if (auth()->user()->hasRole('staff') ||
            ...
            <a class="{{ request()->routeIs('dashboard') ? $activeClass : $inactiveClass }}"
        ...
        <a class="{{ request()->routeIs('loans.*') ? $activeClass : $inactiveClass }}"
        ...
        <a class="{{ request()->routeIs('admin.loans.index') ? $activeClass : $inactiveClass }}"
        ...
        <a class="{{ request()->routeIs('reports.financial*') ? $activeClass : $inactiveClass }}"
