        ...
        <div class="lg:col-span-5 space-y-6">
            ...
            <div class="bg-blue-900 text-white p-8 rounded-lg shadow-xl relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <div class="text-5xl font-black tracking-tighter mb-4">$142,500.80</div>
                    <div class="flex items-center gap-2 text-blue-200 text-sm">
                        <span class="material-symbols-outlined text-sm">lock</span>
                        <span>Total Account Balance: $185,420.00</span>
                    </div>
                </div>
            </div>
            <!-- Tax & Fee Summary -->
            <div class="bg-surface-container-lowest p-8 rounded shadow-sm">
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center pb-4 border-b border-slate-100">
                        ...
                        <p class="font-bold text-error text-lg">-$14,250.08</p>
                    </div>
                    <div class="flex justify-between items-center pb-4 border-b border-slate-100">
                        <div>
                        ...
                        <p class="font-bold text-on-surface text-lg">-$75.00</p>
                    </div>
                    <div class="flex justify-between items-center pt-2">
                        ...
                        <p class="font-black text-blue-700 text-2xl">$128,175.72</p>
                    </div>
                </div>
